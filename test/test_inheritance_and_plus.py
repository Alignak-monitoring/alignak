...
class TestInheritanceAndPlus(AlignakTest):
    ...
    def test_inheritance(self):
        ...
        # Thoses services are attached to all hosts of an hostgroup and they both
        # inherit from the srv-from-hostgroup template
        # Two different ways to get the service ...
        svc1 = self._sched.services.find_by_name("test_host_01/srv-from-hostgroup")
        assert svc1 is not None

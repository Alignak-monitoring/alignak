...
class TestDispatcher(AlignakTest):
    ...
    def test_simple(self):
        ...
        * 1 broker
        ...
        self.assertEqual(6, len(self.schedulers[0].sched.hosts))
    ...
    def test_simple_multi_schedulers(self):
        ...
        * 1 broker
        ...
        self.assertEqual(3, len(self.schedulers[0].sched.hosts))
        self.assertEqual(3, len(self.schedulers[1].sched.hosts))
    ...
    def test_realms(self):
        ...
        * 1 broker
        ...
        self.assertSetEqual(set([4, 6]), set([len(self.schedulers[0].sched.hosts),
                                              len(self.schedulers[1].sched.hosts)]))
    ...
    def test_simple_scheduler_spare(self):
        ...
        with requests_mock.mock() as mockreq:
            ...
            json_managed = {self.schedulers[master_index].conf.uuid:
                            self.schedulers[master_index].conf.push_flavor}

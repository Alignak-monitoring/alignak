...
class TestAcknowledges(AlignakTest):
    ...
    def test_ack_host_sticky_ds_dh(self):
        ...
        cmd = "[{0}] ACKNOWLEDGE_HOST_PROBLEM;{1};{2};{3};{4};{5};{6}\n".\
            format(now, host.host_name, 2, 0, 1, 'darth vader', 'normal process')
    ...
    def test_ack_host_sticky_us_uh_dh(self):
        ...
        host_router = self.schedulers[0].sched.hosts.find_by_name("test_router_0")
        ...
        self.scheduler_loop(1, [[host_router, 2, 'DOWN']], False)
        time.sleep(0.1)
        ...
        self.scheduler_loop(1, [[host_router, 0, 'UP']], False)
        time.sleep(0.1)
    ...
    def test_ack_host_nosticky_ds_dh(self):
        ...
        now = time.time()
        cmd = "[{0}] ACKNOWLEDGE_HOST_PROBLEM;{1};{2};{3};{4};{5};{6}\n". \
            format(now, host.host_name, 1, 0, 1, 'darth vader', 'normal process')
        self.schedulers[0].sched.run_external_command(cmd)
    ...
    def test_ack_service_sticky_ws_wh_ch(self):
        ...
        cmd = "[{0}] ACKNOWLEDGE_SVC_PROBLEM;{1};{2};{3};{4};{5};{6};{7}\n". \
            format(now, host.host_name, svc.service_description, 2, 0, 1, 'darth vader',
                   'normal process')
        self.schedulers[0].sched.run_external_command(cmd)
    ...
    def test_ack_service_nosticky_ws_ch(self):
        ...
        now = time.time()
        cmd = "[{0}] ACKNOWLEDGE_SVC_PROBLEM;{1};{2};{3};{4};{5};{6};{7}\n".\
            format(now, host.host_name, svc.service_description, 1, 0, 1, 'darth vader',
                   'normal process')
        self.schedulers[0].sched.run_external_command(cmd)
    ...
    def test_ack_expire_service_nosticky_ch(self):
        ...
        cmd = "[{0}] ACKNOWLEDGE_SVC_PROBLEM_EXPIRE;{1};{2};{3};{4};{5};{6};{7};{8}\n". \
            format(now, host.host_name, svc.service_description, 1, 0, 1, (now + 2), 'darth vader',
                   'normal process')
        self.schedulers[0].sched.run_external_command(cmd)
    ...
    def test_ack_expire_host_nosticky_dh(self):
        ...
        cmd = "[{0}] ACKNOWLEDGE_HOST_PROBLEM_EXPIRE;{1};{2};{3};{4};{5};{6};{7}\n". \
            format(now, host.host_name, 1, 0, 1, (now + 2), 'darth vader', 'normal process')
        self.schedulers[0].sched.run_external_command(cmd)
    ...
    def test_remove_ack_service_nosticky_ch(self):
        ...
        cmd = "[{0}] REMOVE_SVC_ACKNOWLEDGEMENT;{1};{2}\n". \
            format(now, host.host_name, svc.service_description)
        self.schedulers[0].sched.run_external_command(cmd)

...
class TestBusinesscorrelNotifications(AlignakTest):
    ...
    def test_bprule_standard_notifications(self):
        ...
        self.assertTrue(svc2.is_problem)
        ...
        self.assertEqual(2, svc_cor.business_rule.get_state(self._sched.hosts,
                                                            self._sched.services))
        timeperiod = self._sched.timeperiods[svc_cor.notification_period]
        host = self._sched.hosts[svc_cor.host]
        self.assertIs(False, svc_cor.notification_is_blocked_by_item(timeperiod,
                                                                     self._sched.hosts,
                                                                     self._sched.services,
                                                                     'PROBLEM'))
    ...
    def test_bprule_smart_notifications_ack(self):
        ...
        self.assertIs(True, svc_cor.notification_is_blocked_by_item(timeperiod,
                                                                    self._sched.hosts,
                                                                    self._sched.services,
                                                                    'PROBLEM'))
    ...
    def test_bprule_child_notification_options(self):
        ...
        self.assertEqual(['d', 'x', 'r', 's'], hst2.notification_options)

...
class TestDispatcherMultiBroker(AlignakTest):
    ...
    def test_simple_dispatch(self):
        ...
        self.assert_any_log_match('Dispatch OK of configuration [\w]* to broker broker-all-1')
        self.assert_any_log_match('Dispatch OK of configuration [\w]* to broker broker-all-2')
        self.clear_logs()

...
class TestRealms(AlignakTest):
    ...
    def test_realm_hostgroup_assigntion(self):
        ...
        self.assertIn(in_realm2.get_name(), [self.sched.hostgroups[hg].get_name() for hg in test_host1_hg_realm2.hostgroups])
        ...
        self.assertIn(in_realm2.get_name(), [self.sched.hostgroups[hg].get_name() for hg in test_host2_hg_realm2.hostgroups])
        ...
        self.assertIn(in_realm2.get_name(), [self.sched.hostgroups[hg].get_name() for hg in test_host3_hg_realm2.hostgroups])
    ...
    def test_sub_realms_assignations(self):
        ...
        self.sched.conf.realms.prepare_for_satellites_conf((self.sched.conf.reactionners,
                                                            self.sched.conf.pollers,
                                                            self.sched.conf.brokers,
                                                            self.sched.conf.receivers))

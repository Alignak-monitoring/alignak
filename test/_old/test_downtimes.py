...
class TestDowntime(AlignakTest):
    ...
    def test_schedule_fixed_svc_downtime(self):
        ...
        self.assertIn(svc.downtimes[0], self.sched.downtimes)
        self.assertTrue(self.sched.downtimes[svc.downtimes[0]].fixed)
        self.assertTrue(self.sched.downtimes[svc.downtimes[0]].is_in_effect)
        self.assertFalse(self.sched.downtimes[svc.downtimes[0]].can_be_deleted)
        self.assertEqual(1, len(self.sched.comments))
        self.assertEqual(1, len(svc.comments))
        self.assertIn(svc.comments[0], self.sched.comments)
        self.assertEqual(self.sched.comments[svc.comments[0]].uuid, self.sched.downtimes[svc.downtimes[0]].comment_id)
        ...
        cmd = "[%lu] DEL_SVC_DOWNTIME;%s" % (now, self.sched.downtimes[svc.downtimes[0]].uuid)
        self.sched.run_external_command(cmd)
        self.assertEqual(1, len(self.sched.downtimes))
        self.assertEqual(1, len(svc.downtimes))
        ...
        self.assertTrue(self.sched.downtimes[svc.downtimes[0]].fixed)
        self.assertFalse(self.sched.downtimes[svc.downtimes[0]].is_in_effect)
        self.assertTrue(self.sched.downtimes[svc.downtimes[0]].can_be_deleted)
        self.assertEqual(1, len(self.sched.comments))
        self.assertEqual(1, len(svc.comments))
    ...
    def test_schedule_flexible_svc_downtime(self):
        ...
        self.assertEqual(1, len(svc.downtimes))
        self.assertIn(svc.downtimes[0], self.sched.downtimes)
        self.assertFalse(self.sched.downtimes[svc.downtimes[0]].fixed)
        self.assertFalse(self.sched.downtimes[svc.downtimes[0]].is_in_effect)
        self.assertFalse(self.sched.downtimes[svc.downtimes[0]].can_be_deleted)
        self.assertEqual(1, len(self.sched.comments))
        self.assertEqual(1, len(svc.comments))
    ...
    def test_schedule_fixed_host_downtime(self):
        ...
        self.assertIn(host.downtimes[0], self.sched.downtimes)
        self.assertTrue(self.sched.downtimes[host.downtimes[0]].fixed)
        self.assertTrue(self.sched.downtimes[host.downtimes[0]].is_in_effect)
        self.assertFalse(self.sched.downtimes[host.downtimes[0]].can_be_deleted)
        self.assertEqual(1, len(self.sched.comments))
        self.assertEqual(1, len(host.comments))
        self.assertIn(host.comments[0], self.sched.comments)
        self.assertEqual(self.sched.comments[host.comments[0]].uuid, self.sched.downtimes[host.downtimes[0]].comment_id)
        self.show_logs()
        self.show_actions()
    ...
    def test_schedule_fixed_host_downtime_with_service(self):
        ...
        self.assertEqual(0, len(svc.downtimes))
        self.assertFalse(svc.in_scheduled_downtime)
        self.assertTrue(self.sched.find_item_by_id(svc.host).in_scheduled_downtime)
        self.show_logs()
        self.show_actions()

...
from urlparse import parse_qs as parseqs, urljoin, SplitResult as UrlSplitResult
...
class BaseRequest(DictMixin):
    ...
    def query(self):
        """ The :attr:`query_string` parsed into a :class:`MultiDict`. These
            ...
            :class:`Router`. """
        data = parseqs(self.query_string, keep_blank_values=True)
...
ERROR_PAGE_TEMPLATE = """
%try:
    %from alignak.webui.bottlecore import DEBUG, HTTP_CODES, request, touni

...
=================================
Migrating from Nagios to Alignak 
=================================
...
- First you launch alignak with both NagiosRetention and PickleRetention modules. It will load data from NagiosRetention and save them in a more "efficient" file. So add in *alignak-specififc.cfg* file both modules for your scheduler object: 
...
.. important::  This method has met with limited success, further testing of the NagiosRetention module is required. An issues encountered should be raised in the Alignak issue tracker on github.

...
An integrated acquisition module is an optional piece of software that is launched by a Alignak daemon. The module is responsible for doing data acquisition using a specific protocol in a very high performance method. This is preferred over repeatedly calling plugin scripts.
...
Alignak provides an integrated SNMP data acquisition module: SnmpBooster
